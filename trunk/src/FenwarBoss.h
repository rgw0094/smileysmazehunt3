...
public:
	...
	static const int ORB_HEALTH = 1.5;
	static const int ORB_ATTACK_DURATION = 3.15;
	static const int ORB_COUNT = 8;
	static const int BULLET_DAMAGE = 1.0;
	static const int BULLET_SPEED = 400.0;
	static const int BOMB_DAMAGE = 1.5;
	static const int BOMB_DELAY = 7.0;
	static const int ATTACK_DELAY = 13.0;
